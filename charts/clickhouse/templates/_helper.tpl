...
{{/*
Set clickhouse-keeper host
*/}}
{{- define "clickhouse.clickhouse-keeper.servicename" -}}
{{- if (index .Values "clickhouse-keeper" "fullnameOverride") -}}
{{- (index .Values "clickhouse-keeper" "fullnameOverride") | trunc 63 | trimSuffix "-" -}}
{{- else if (index .Values "clickhouse-keeper" "nameOverride") -}}
{{- printf "%s-%s" .Release.Name (index .Values "clickhouse-keeper" "nameOverride") | trunc 63 | trimSuffix "-" -}}
{{- else -}}
...
*/}}
{{- define "clickhouse.clickhouse-keeper.port" -}}
{{- default 2181 }}
{{- end }}
...
*/}}
{{- define "clickhouse.clickhouse-keeper.headlessSvcSuffix" -}}
{{- $namespace := (index .Values "clickhouse-keeper" "namespaceOverride") }}
{{- $clusterDomain := default "cluster.local" .Values.global.clusterDomain }}
{{- $name := printf "%ss" (include "clickhouse.clickhouse-keeper.servicename" .) }}
